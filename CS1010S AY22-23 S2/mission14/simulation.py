...
def task1(tribute_ai, gui=False):
    ...
    if not gui:
        ...
        simulation_finish_callback()
    else:
        gui_simulation.animate_game_logger_events(game_map.layout, simulation_finish_callback)
...
def optional_task(tribute_ai, config, gui=False):
    ...
    if not gui:
        ...
        gui_simulation.animate_game_logger_events(game.map.layout, simulation_finish_callback)
